...
<head>
    ...
    <title>{{ config('app.name', 'Rapid Concretech') }} - Supplier</title>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav class="menu">
                ...
                <a href="{{ route('billings.index') }}" class="menu-item {{ request()->routeIs('billings.*') ? 'active' : '' }}">
                    Billing
                </a>
            </nav>
        </aside>
            ...
            <div class="content-header">
                ...
                <div class="user-dropdown">
                    <button class="user-dropdown-btn">
                        ...
                        {{ Auth::user()->name }}
                        <span class="position-badge">Supplier</span>
                    </button>
