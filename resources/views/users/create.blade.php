                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="position" class="form-control @error('position') is-invalid @enderror" name="position" required>
                                    ...
                                    <option value="inventory-staff" {{ old('position') == 'inventory-staff' ? 'selected' : '' }}>Inventory Staff</option>
                                    <option value="supplier" {{ old('position') == 'supplier' ? 'selected' : '' }}>Supplier</option>
                                </select>
                                @error('position')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
