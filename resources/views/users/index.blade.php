...
<div class="container-fluid">
    <div class="content-header">
        <h2>Manage Users</h2>
        <div>
            <a href="{{ route('users.create') }}" class="action-button">
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="search-container">
                    <input type="text" id="userSearch" class="search-input" placeholder="Search users..." onkeyup="searchTable()">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($user->last_login_at)
                                    <span class="timestamp" title="{{ $user->last_login_at }}">
                                        {{ $user->last_login_at }}
                                    </span>
                                @else
                            ...
                            <td class="action-links text-center">
                                ...
                                <a href="#" class="btn-delete" title="Delete User" onclick="event.preventDefault(); confirmDelete('{{ $user->id }}', '{{ $user->name }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
<script>
    ...
    function sortTable(columnIndex) {
        ...
        // Sort the rows
        rows.sort((rowA, rowB) => {
            // Skip if it's the "No users found" row
